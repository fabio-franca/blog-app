...
router.post("/registro", (req,res)=>{
    ...
    if(erros.length>0){
        ...
        Usuario.findOne({email: req.body.email}).then((usuario)=>{  //Pesquisa por email
            if(usuario){                                //Se tiver um usuario com esse email, informa e não salva
                ...
                bcrypt.genSalt(10, (erro,salt)=>{   //Encripta a senha
